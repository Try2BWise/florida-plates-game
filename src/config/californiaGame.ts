...
export const californiaGame: GameDefinition & {
  ...
  branding: {
    ...
    attribution: {
      text: "Plate images are not the intellectual property of Gorilla Grin. California license plate designs, including specialty plate artwork, belong to the {agency} and/or their respective licensors and are displayed here solely for identification, educational, and non-commercial reference purposes under a fair use claim (17 U.S.C. § 107). Certain specialty plate designs feature artwork licensed by the {agency} from third-party organizations; those marks and designs remain the property of their respective owners. No affiliation with, endorsement by, or commercial license from the {agency} or any depicted organization is claimed or implied.",
  ...
  about: { fairUseNotice: "Plate images are not the intellectual property of Gorilla Grin. California license plate designs, including specialty plate artwork, belong to the California Department of Motor Vehicles and/or their respective licensors and are displayed here solely for identification, educational, and non-commercial reference purposes under a fair use claim (17 U.S.C. § 107). Certain specialty plate designs feature artwork licensed by the California DMV from third-party organizations; those marks and designs remain the property of their respective owners. No affiliation with, endorsement by, or commercial license from the California DMV or any depicted organization is claimed or implied." }
};
