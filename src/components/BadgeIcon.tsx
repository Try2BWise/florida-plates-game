...
const customBadgeArtById: Record<string, string> = {
  ...
  // Kansas
  "ks-northwest-explorer": "compass-new.png",
  "ks-northeast-explorer": "compass-new.png",
  "ks-southwest-explorer": "compass-new.png",
  "ks-south-central-explorer": "compass-new.png",
  "ks-southeast-explorer": "compass-new.png",
  "all-around-kansas": "sunflower.png",
  // Georgia
  "ga-north-georgia-explorer": "mountain.png",
  "ga-metro-atlanta-explorer": "compass-new.png",
  "ga-central-georgia-explorer": "compass-new.png",
  "ga-southwest-georgia-explorer": "compass-new.png",
  "ga-southeast-georgia-explorer": "compass-new.png",
  "all-around-georgia": "peach.png",
  // Alabama
  "al-north-alabama-explorer": "compass-new.png",
  "al-central-alabama-explorer": "compass-new.png",
  "al-west-alabama-explorer": "compass-new.png",
  "al-southeast-alabama-explorer": "compass-new.png",
  "al-gulf-coast-explorer": "water-wave.png",
  "all-around-alabama": "compass-new.png",
  // Alaska
  "ak-southcentral-explorer": "compass-new.png",
  "ak-southeast-explorer": "compass-new.png",
  "ak-interior-explorer": "mountain.png",
  "ak-southwest-explorer": "compass-new.png",
  "ak-arctic-explorer": "compass-new.png",
  "all-around-alaska": "polar-bear.png",
  // Arizona
  "az-central-explorer": "compass-new.png",
  "az-southern-explorer": "compass-new.png",
  "az-northern-explorer": "mountain.png",
  "az-western-explorer": "compass-new.png",
  "az-eastern-explorer": "compass-new.png",
  "all-around-arizona": "cactus.png",
  // California
  "ca-socal-explorer": "compass-new.png",
  "ca-central-explorer": "compass-new.png",
  "ca-bay-area-explorer": "compass-new.png",
  ...
  // Minnesota
  "mn-northwest-explorer": "compass-new.png",
  "mn-northeast-explorer": "water-wave.png",
  "mn-central-explorer": "compass-new.png",
  "mn-metro-explorer": "compass-new.png",
  "mn-southern-explorer": "compass-new.png",
  "all-around-minnesota": "compass-new.png",
};
